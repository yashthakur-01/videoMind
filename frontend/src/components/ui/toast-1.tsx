...
function ToastList() {
  ...
  return toasts.map((toast) => (
    ...
    >
      <Toast.Title className="text-[0.975rem] leading-5 font-semibold text-white" />
      <Toast.Description className="text-[0.925rem] leading-5 text-slate-200" />
      <Toast.Close
        className="absolute top-2 right-2 flex h-5 w-5 items-center justify-center rounded border-none bg-transparent text-slate-400 hover:bg-white/10 hover:text-white"
        aria-label="Close"
      >
